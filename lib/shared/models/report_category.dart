...
extension ReportCategoryExt on ReportCategory {
  ...
  IconData get icon {
    switch (this) {
      case ReportCategory.bacPoubelleSature:   return Icons.delete_outline_rounded;
      ...
      case ReportCategory.eauxUsees:           return Icons.water_outlined;
  ...
  Color get color {
    switch (this) {
      case ReportCategory.bacPoubelleSature:   return const Color(0xFF4CAF50);
      ...
      case ReportCategory.eauxUsees:           return const Color(0xFF00ACC1);

...
class _GroupsPageState extends State<GroupsPage> {
  ...
  // "Appliquer" en bas pour fermer la modale. Design d'origine restauré
  // (bottom sheet standard, pleine largeur, glissant depuis le bas) — le
  // panneau ancré à gauche introduit par erreur a été retiré ; seul le
  // bouton "Filtres" qui l'ouvre est désormais aligné à gauche.
